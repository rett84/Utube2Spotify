<%@ Page Title="PlayList Converter" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GenfromYT.aspx.cs" Inherits="PlayListCreator_FW.Pages.GenfromYT" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display: flex; justify-content: flex-start; gap: 20px; flex-wrap: wrap; margin-top: 25px; margin-left: -125px;">
        <!-- YouTube Playlist -->
       <div style="background-color: rgba(255,255,255,0.7); padding: 15px; border-radius: 8px;
         ...
         <div style="background-color: rgba(255,255,255,0.7); padding: 15px; border-radius: 8px;
           max-width: 500px; width: 100%;">
            ...
            <asp:Label ID="lblCountSongsInserted" runat="server" ClientIDMode="Static" />
        </div>

        <div style="display: flex; flex-direction: column; gap: 10px; ">
            <asp:Button ID="ButtonCSV" runat="server" Text="Download Youtube List to CSV" CssClass="btn btn-success rounded-pill px-4" OnClick="ButtonCSV_Click"  />
            <asp:Button ID="ButtontoSpotify" runat="server" Text="Export to Spotify Playlist"
                CssClass="btn btn-danger rounded-pill px-4"  OnClick="ButtontoSpotify_Click" />
        </div>
        <asp:HiddenField ID="hfConnectionId" runat="server" />
    </div>

    <div class="jumbotron text-center bg-primary text-white py-5 rounded"  style="margin-left: -125px; background-color: rgba(255,255,255,0.8);">
    ...
    <!-- Modal -->
    <div id="instructionsModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="instructionsModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="instructionsModal-title">Notice</h4>
          </div>
          <div class="modal-body">
            This is your message here.
          </div>
      ...
      <!-- Modal -->
    <div id="ExportedSucessModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ExportedSucessLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <h4 class="modal-title" id="ExportedSucessModal-title">Notice</h4>
          </div>
          <div class="modal-body">
            This is your message here.
          </div>
